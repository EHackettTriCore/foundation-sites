...
If you don't see the right helper, you can write your own. Add a javascript file to 'src/helpers', add the `helpers: 'src/helpers'` option to the Panini process gulpfile.babel.js, restart npm, then call it in your templates.
